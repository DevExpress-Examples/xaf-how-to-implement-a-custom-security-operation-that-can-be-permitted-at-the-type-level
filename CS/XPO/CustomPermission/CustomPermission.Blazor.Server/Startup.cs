...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<CustomPermissionBlazorApplication>();
            builder.Modules
            	...
            	.Add<CustomPermissionBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(CustomPermission.Module.BusinessObjects.ApplicationUser);
