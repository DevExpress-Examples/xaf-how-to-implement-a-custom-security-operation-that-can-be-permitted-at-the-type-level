...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<CustomPermissionEFWindowsFormsApplication>();
        builder.Modules
        	...
        	.Add<CustomPermissionEFWinModule>();
        builder.ObjectSpaceProviders
            .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                .WithDbContext<CustomPermissionEF.Module.BusinessObjects.CustomPermissionEFEFCoreDbContext>((application, options) => {
